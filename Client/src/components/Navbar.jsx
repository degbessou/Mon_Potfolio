    ...
    return (
        <div className="navbar bg-base-200 font-agrandir-narrow font-bold shadow-sm">
            ...
            <div className="mx-auto max-w-screen-xl w-full px-2 lg:px-4 flex items-center justify-between">
                ...
                {/* MENU HORIZONTAL – visible lg+ */}
                <div className="hidden lg:flex flex-1 justify-center">
                    <ul className="menu menu-horizontal px-1 gap-2">
                        <li><a href="#experiences" onClick={(e) => handleSmoothScroll(e, 'experiences')}>Expériences</a></li>
                        <li><a href="#projets" onClick={(e) => handleSmoothScroll(e, 'projets')}>Projets</a></li>
                        <li><a href="#education" onClick={(e) => handleSmoothScroll(e, 'education')}>Éducation</a></li>
                        <li><a href="#informations" onClick={(e) => handleSmoothScroll(e, 'informations')}>Informations</a></li>
                ...
                <div className="flex items-center">
                    <div className="dropdown dropdown-end">
                        <div tabIndex={0} role="button" className="btn hover:bg-primary hover:text-white hover:font-medium transition-colors duration-300">
                            Obtenir mon CV
                        </div>
                        <ul tabIndex={0} className="menu dropdown-content bg-base-200 rounded-box z-10 mt-4 w-52 p-2 shadow-sm">
