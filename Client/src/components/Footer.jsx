    ...
    return (
        <footer className="footer bg-base-300 text-base-content border-base-300 border-t px-24 py-4">
            <aside className="grid-flow-col items-center">
                ...
                <p>
                    Portfolio (v1.0.0) réalisé avec passion par <strong>DEGBESSOU DONALD</strong>
                    <br /> Ouvrez ce portfolio sur un ordinateur pour une meilleure expérience.
                    <br />
            ...
            <nav className="md:place-self-center md:justify-self-end">
                <div className="grid grid-flow-col gap-4">
                    <a href="https://www.linkedin.com/in/donald-kenneth-degbessou-684b74149/" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="mailto:degbessou.ca@gmail.com?subject=Proposition%20d%27offre%20d%27emploi&body=Bonjour...%0D%0A%0D%0A" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.instagram.com/deg.bessou/" target="_blank" rel="noopener noreferrer">
