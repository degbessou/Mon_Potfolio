const Card = ({
    ...
    return (
        <div className="card card-border bg-base-300 w-104">
            <div className="card-body hover:bg-gray-50 duration-150">
                <a className="space-y-3">
                    <div className="flex items-center gap-x-3">
                        ...
                        <div>
                            <span className="block text-sm text-info-content font-medium">{title}</span>
                            <h3 className="text-base-content font-semibold mt-1 w-72">{school}</h3>
                        </div>
                    </div>
                    <p className="text-base-content sm:text-sm">
                        {description}
                    </p>
